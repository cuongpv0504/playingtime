            ...
            <div class="card gedf-card" id="<?php echo $key; ?>">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="mr-2">
                                <a href="<?php if( $user_data['id'] == $value['user_id'] || $user_data['role'] == 1 || $user_data['role'] == 2){ echo '/users/profile/'.$value['user_id'];}?>"><img class="rounded-circle" width="45" src="<?php echo $value['author']['avatar'] ?>" ></a>
                            </div>
                            <div class="ml-2">
